...
public class HallLightCanPayloadTranslator extends CanPayloadTranslator {

	public HallLightCanPayloadTranslator(ReadableCanMailbox payload, int floor, Hallway hallway, Direction direction) {
		super(payload, 8, MessageDictionary.HALL_LIGHT_BASE_CAN_ID + ReplicationComputer.computeReplicationId(floor, hallway, direction));
	}
